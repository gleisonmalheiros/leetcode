/**
 ...
 Count the number of different letters that appear in both uppercase and lowercase where all lowercase occurrences of the given letter appear before any uppercase occurrence.
...
public class LetterOccurrence {
    ...
    public int solution(String letters) {
        // TODO write solution to LetterOccurrence problem (unit tests already set)
        return -1;
    }
